...
#include "interfaces/msg/detail/concert_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // prices, remng_durations, remng_ticket
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // prices, remng_durations, remng_ticket
...
using _ConcertInfo__ros_msg_type = interfaces__msg__ConcertInfo;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__msg__ConcertInfo(
  const interfaces__msg__ConcertInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: remng_ticket
  {
    size_t size = ros_message->remng_ticket.size;
    auto array_ptr = ros_message->remng_ticket.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__msg__ConcertInfo(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__msg__ConcertInfo * ros_message)
{
  // Field name: concert_count
  {
    cdr >> ros_message->concert_count;
  ...
  // Field name: prices
  {
    ...
    if (ros_message->prices.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->prices);
    }
  ...
  // Field name: remng_durations
  {
    ...
    if (ros_message->remng_durations.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->remng_durations);
    }
  ...
  // Field name: remng_ticket
  {
    ...
    if (ros_message->remng_ticket.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->remng_ticket);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->remng_ticket, size)) {
      fprintf(stderr, "failed to create array for field 'remng_ticket'");
      return false;
    }
    auto array_ptr = ros_message->remng_ticket.data;
    cdr.deserialize_array(array_ptr, size);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__msg__ConcertInfo(
  ...
  size_t current_alignment)
{
  ...
  // Field name: remng_ticket
  {
    size_t array_size = ros_message->remng_ticket.size;
    auto array_ptr = ros_message->remng_ticket.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__ConcertInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__ConcertInfo;
    is_plain =
      (
      offsetof(DataType, remng_ticket) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__msg__ConcertInfo(
  const interfaces__msg__ConcertInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: concert_count
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__msg__ConcertInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ConcertInfo__ros_msg_type * ros_message = static_cast<const _ConcertInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__msg__ConcertInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__ConcertInfo * ros_message = static_cast<const interfaces__msg__ConcertInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__ConcertInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__ConcertInfo * ros_message = static_cast<interfaces__msg__ConcertInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__ConcertInfo(cdr, ros_message);
}

static uint32_t _ConcertInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__ConcertInfo(
...
static size_t _ConcertInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__ConcertInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, ConcertInfo)() {
