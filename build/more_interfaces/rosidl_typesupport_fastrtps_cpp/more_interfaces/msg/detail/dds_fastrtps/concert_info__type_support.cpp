...
#include "more_interfaces/msg/detail/concert_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const more_interfaces::msg::ConcertInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::msg::ConcertInfo & ros_message)
{
  // Member: concert_count
  cdr >> ros_message.concert_count;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = more_interfaces::msg::ConcertInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const more_interfaces::msg::ConcertInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<more_interfaces::msg::ConcertInfo *>(
    untyped_ros_message);
...
{
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_ConcertInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, msg, ConcertInfo)() {
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_ConcertInfo__handle;
}
