...
#ifndef MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__STRUCT_HPP_
#define MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__more_interfaces__msg__ConcertInfo __attribute__((deprecated))
#else
# define DEPRECATED__more_interfaces__msg__ConcertInfo __declspec(deprecated)
#endif
...
struct ConcertInfo_
{
  ...
  // pointer types
  using RawPtr =
    more_interfaces::msg::ConcertInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const more_interfaces::msg::ConcertInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      more_interfaces::msg::ConcertInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__more_interfaces__msg__ConcertInfo
    std::shared_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__more_interfaces__msg__ConcertInfo
    std::shared_ptr<more_interfaces::msg::ConcertInfo_<ContainerAllocator> const>
...
using ConcertInfo =
  more_interfaces::msg::ConcertInfo_<std::allocator<void>>;
...
#endif  // MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__STRUCT_HPP_
