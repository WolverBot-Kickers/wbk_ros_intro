...
more_interfaces__msg__ConcertInfo__init(more_interfaces__msg__ConcertInfo * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->concert_names, 0)) {
    more_interfaces__msg__ConcertInfo__fini(msg);
    return false;
  }
  // musn_names
  ...
  // prices
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->prices, 0)) {
    more_interfaces__msg__ConcertInfo__fini(msg);
    return false;
  }
  // remng_durations
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->remng_durations, 0)) {
    more_interfaces__msg__ConcertInfo__fini(msg);
    return false;
  }
  return true;
...
more_interfaces__msg__ConcertInfo__fini(more_interfaces__msg__ConcertInfo * msg)
{
  ...
  // prices
  rosidl_runtime_c__uint8__Sequence__fini(&msg->prices);
  // remng_durations
  rosidl_runtime_c__uint8__Sequence__fini(&msg->remng_durations);
}
...
more_interfaces__msg__ConcertInfo__create(void)
{
  ...
  more_interfaces__msg__ConcertInfo * msg = (more_interfaces__msg__ConcertInfo *)allocator.allocate(sizeof(more_interfaces__msg__ConcertInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(more_interfaces__msg__ConcertInfo));
  bool success = more_interfaces__msg__ConcertInfo__init(msg);
  if (!success) {
...
more_interfaces__msg__ConcertInfo__Sequence__init(more_interfaces__msg__ConcertInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  more_interfaces__msg__ConcertInfo * data = NULL;

  if (size) {
    data = (more_interfaces__msg__ConcertInfo *)allocator.zero_allocate(size, sizeof(more_interfaces__msg__ConcertInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = more_interfaces__msg__ConcertInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        more_interfaces__msg__ConcertInfo__fini(&data[i - 1]);
      }
...
more_interfaces__msg__ConcertInfo__Sequence__fini(more_interfaces__msg__ConcertInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      more_interfaces__msg__ConcertInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  more_interfaces__msg__ConcertInfo__Sequence * array = (more_interfaces__msg__ConcertInfo__Sequence *)allocator.allocate(sizeof(more_interfaces__msg__ConcertInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = more_interfaces__msg__ConcertInfo__Sequence__init(array, size);
  if (!success) {
...
more_interfaces__msg__ConcertInfo__Sequence__destroy(more_interfaces__msg__ConcertInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    more_interfaces__msg__ConcertInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
more_interfaces__msg__ConcertInfo__Sequence__are_equal(const more_interfaces__msg__ConcertInfo__Sequence * lhs, const more_interfaces__msg__ConcertInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!more_interfaces__msg__ConcertInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  more_interfaces__msg__ConcertInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(more_interfaces__msg__ConcertInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    more_interfaces__msg__ConcertInfo * data =
      (more_interfaces__msg__ConcertInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!more_interfaces__msg__ConcertInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          more_interfaces__msg__ConcertInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!more_interfaces__msg__ConcertInfo__copy(
