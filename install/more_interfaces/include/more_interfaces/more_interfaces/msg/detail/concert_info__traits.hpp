...
#ifndef MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__TRAITS_HPP_
#define MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const more_interfaces::msg::ConcertInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const more_interfaces::msg::ConcertInfo & msg)
{
  return more_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<more_interfaces::msg::ConcertInfo>()
{
  return "more_interfaces::msg::ConcertInfo";
}

template<>
inline const char * name<more_interfaces::msg::ConcertInfo>()
{
  return "more_interfaces/msg/ConcertInfo";
}

template<>
struct has_fixed_size<more_interfaces::msg::ConcertInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<more_interfaces::msg::ConcertInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<more_interfaces::msg::ConcertInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MORE_INTERFACES__MSG__DETAIL__CONCERT_INFO__TRAITS_HPP_
